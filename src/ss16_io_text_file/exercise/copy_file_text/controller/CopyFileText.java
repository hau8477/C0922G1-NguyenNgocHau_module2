...
public class CopyFileText {
    public static final String SOURCE_FILE = "src/ss16_io_text_file/exercise/copy_file_text/data/source_file.txt";
    public static final String TARGET_FILE = "src/ss16_io_text_file/exercise/copy_file_text/data/target_file.txt";
    ...
    public void writeFile(String SOURCE_FILE) {
        ...
        try {
            ...
            bufferedWriter.write("Ngọc Hậu\n");
            bufferedWriter.write("Văn Hùng\n");
            bufferedWriter.write("Ngọc Vũ\n");
            bufferedWriter.write("Đức Vũ\n");
        } catch (IOException e) {
